function New-VMFromDebianImage {
    <#
    .SYNOPSIS
        Creates a Debian VM from Debian Cloud image.
    
    .DESCRIPTION
        Creates a Hyper-V Generation 2 VM from a Debian cloud image with cloud-init configuration.
    ...
    .EXAMPLE
        New-VMFromDebianImage -SourcePath "debian.qcow2" -VMName "Debian01" -RootPassword "P@ssw0rd!" -VHDXSizeBytes 60GB
        Creates a Debian VM with password authentication.
    #>
    [CmdletBinding()]
    param(
