function New-WindowsUnattendFile {
    <#
    .SYNOPSIS
        Creates an unattended answer file for Windows installation.
    
    .DESCRIPTION
        Creates an unattended answer file tailored for the specified Windows version.
        The administrator password is encrypted in the XML and written to the specified file path.
    
    .PARAMETER AdministratorPassword
        The administrator password in plain text.
    
    .PARAMETER Version
        The Windows version.
    
    .PARAMETER ComputerName
        The computer name. Use '*' to randomize during setup (default).
    
    .PARAMETER FilePath
        The file path for the answer file. Default is $env:TEMP\unattend.xml.
    
    .PARAMETER Locale
        The locale to use. Default is en-US.
    
    .PARAMETER AddVirtioDrivers
        If specified, adds commands to install VirtIO and QEMU Guest Agent MSI.
    
    .OUTPUTS
        System.String
        Returns the path to the created answer file.
    
    .EXAMPLE
        New-WindowsUnattendFile -AdministratorPassword "P@ssw0rd!" -Version "Server2022Standard"
        Creates an unattend.xml file for Windows Server 2022 Standard.
    #>
    [CmdletBinding()]
    param(
