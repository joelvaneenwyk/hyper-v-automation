function New-VMFromUbuntuImage {
    <#
    .SYNOPSIS
        Creates an Ubuntu VM from Ubuntu Cloud image.
    
    .DESCRIPTION
        Creates a Hyper-V Generation 2 VM from an Ubuntu cloud image with cloud-init configuration.
        Requires administrative privileges and qemu-img to be installed.
    ...
    .EXAMPLE
        New-VMFromUbuntuImage -SourcePath "ubuntu.img" -VMName "Ubuntu01" -RootPassword "P@ssw0rd!" -VHDXSizeBytes 60GB
        Creates an Ubuntu VM with password authentication.
    #>
[CmdletBinding()]
param(
